...
public class register extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_regsiter=v.findViewById(R.id.btn_register_registerFragment);
        btn_regsiter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                listener.onRegisterRegisterClick("register");
            }
        });
        return v;
    }
    public interface onRegisterFragmentClicked{
        void onRegisterRegisterClick(String RegisterClciked);
    }
}